...
wget https://svn.code.sf.net/p/apertium/svn/branches/packaging/trunk/apertium-lex-tools/make-deb-source.pl -O make-deb-source.pl
chmod +x *.pl
...
do
	...
	reprepro -b /home/apertium/public_html/apt/nightly/ includedeb $DISTRO /var/cache/pbuilder/result/*$DISTRO*.deb 2>&1 | tee -a /home/apertium/public_html/apt/logs/apertium-lex-tools/reprepro.log
done
