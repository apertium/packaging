...
do
	...
	cowbuilder --update --basepath /var/cache/pbuilder/base-$DISTRO-i386.cow/ >/home/apertium/public_html/apt/logs/apertium-br-fr/$DISTRO-i386.log
	echo "Building $DISTRO for i386"
	cowbuilder --build *$DISTRO*.dsc --basepath /var/cache/pbuilder/base-$DISTRO-i386.cow/ >>/home/apertium/public_html/apt/logs/apertium-br-fr/$DISTRO-i386.log 2>&1 &
done
