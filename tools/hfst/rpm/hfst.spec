...
Requires: libhfst56 = %{version}-%{release}
Requires: grep
Requires: python3
Requires: sed
...
%endif
autoreconf -fi
%configure --disable-static --enable-all-tools --with-readline --enable-python-bindings
make %{?_smp_mflags}
...
%post -n libhfst56 -p /sbin/ldconfig

%postun -n libhfst56 -p /sbin/ldconfig
