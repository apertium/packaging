...
rm -fv ~apertium/public_html/osx/nightly/$PKG_NAME-[0-9]*.zip
rm -fv ~apertium/public_html/osx/nightly/$PKG_NAME-[0-9]*.7z
rm -fv ~apertium/public_html/osx/nightly/$PKG_NAME-[0-9]*.tar.bz2
mv -v *.zip ~apertium/public_html/osx/nightly/
mv -v *.7z ~apertium/public_html/osx/nightly/
mv -v *.tar.bz2 ~apertium/public_html/osx/nightly/
