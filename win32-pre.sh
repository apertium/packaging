...
export PKG_CONFIG="/opt/mxe/usr/bin/$AUTOPKG_BITWIDTH-w64-mingw32.shared-pkg-config"
export PKG_CONFIG_PATH_${AUTOPKG_BITWIDTH}_w64_mingw32_shared="/opt/win32/lib/pkgconfig"
export PKG_NAME=$1
export PKG_REV=$2
export PKG_VER=$3
export PKG_PATH=$4
